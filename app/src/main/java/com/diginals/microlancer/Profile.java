...
public class Profile extends FragmentActivity
    ...
    public void onInfoWindowClick(Marker marker) {
        Toast.makeText(this, "Job Confirmed", Toast.LENGTH_LONG).show();
    ...
    public void onMapReady(GoogleMap map) {
        ...
        enableMyLocation();
        mMap.addMarker(new MarkerOptions().position(new LatLng(43.641143, -79.378187)).title("Admin Paper Work - 88 Queens Quay"));
